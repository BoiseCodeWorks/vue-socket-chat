<template>
  <div class="center dark">
    ...
    <div class="content no-select"><img class="responsive-img" src="https://bcw.blob.core.windows.net/public/img/www/assets/img/logos/cw-logo-square-black-outline.png" width="250"/>
      <div class="section">
        <div class="z-depth-1 grey lighten-4 row">
          <form class="col s12 text-black" @submit.prevent="formAction" v-if="!showReset">
            ...
            <div class="row">
              ...
              <label style="float: right">
                <div class="action muted pink-text" @click="showReset = true"><b>Forgot Password?</b></div>
              </label>
            </div>
            <center>
              <div class="row">
          ...
          <form class="col s12 text-black" @submit.prevent="reset" v-else>
            <div class="row m-t-2">
              ...
              <label style="float: right">
                <div class="action muted pink-text" @click="showReset = false"><b>login</b></div>
              </label>
            </div>
            <center>
              <div class="row">
